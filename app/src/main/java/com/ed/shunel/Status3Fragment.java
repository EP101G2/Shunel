...
public class Status3Fragment extends Fragment {
    ...
    private SearchView svOrderStatus3;
...
//        setting search view
        svOrderStatus3 = view.findViewById(R.id.svOrderStatus3);
        svOrderStatus3.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
            public boolean onQueryTextChange(String newText) {
                Status3Fragment.OrderMainAdapter3 adapter = (Status3Fragment.OrderMainAdapter3) rvOdLStatus3.getAdapter(); //強迫子型recyclerview.getadapter轉型成父型friendadapter
                try{
        ...
        public void onBindViewHolder(@NonNull Status3Fragment.OrderMainAdapter3.PageViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_status3Fragment_to_orderDetailFragment2, bundle);
                }
            });
        }
