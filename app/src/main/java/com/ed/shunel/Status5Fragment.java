...
public class Status5Fragment extends Fragment {
    ...
    private SearchView svOrderStatus5;
...
//        setting search view
        svOrderStatus5 = view.findViewById(R.id.svOrderStatus5);
        svOrderStatus5.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
            public boolean onQueryTextChange(String newText) {
                Status5Fragment.OrderMainAdapter5 adapter = (Status5Fragment.OrderMainAdapter5) rvOdLStatus5.getAdapter(); //強迫子型recyclerview.getadapter轉型成父型friendadapter
                try{
